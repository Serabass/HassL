...
public class ExpressionsTests
{
    ...
    {
        // Act
        var result = HassLanguageParser.Parse($"automation \"Test\" {{ when test.value {op} 5 {{ do test(); }} }}");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when test.value > 5 && test.value < 10 { do test(); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when test.value > 5 || test.value < 0 { do test(); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when (test.value > 5) { do test(); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when test.device.entity { do test(); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when test.func(1, 2) { do test(); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when time in 08:00..18:00 { do test(); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when temp in 20..25 { do test(); } }");
