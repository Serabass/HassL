...
public class DeclarationsTests
{
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("home \"TestHome\" test { room \"TestRoom\" room kitchen { } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("home \"TestHome\" test { room \"TestRoom\" room { device \"TestDevice\" device { } } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("home \"TestHome\" test { room \"TestRoom\" room { device \"TestDevice\" device light { } } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("home \"TestHome\" test { room \"TestRoom\" room { device \"TestDevice\" device { entities: [ light main { id: \"light.main\"; } ]; } } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("home \"TestHome\" test { room \"TestRoom\" room { device \"TestDevice\" device { entities: [ sensor temp { id: \"sensor.temp\"; unit: \"°C\"; min: 0; max: 100; }; ]; } } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"TestAutomation\" { when test.value == 5 { do test(); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"TestAutomation\" { when test.value == 5 { do test1(); } when test.value == 10 { do test2(); } }");
