...
public class ConditionsTests
{
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when test.value == 5 for 30m { do test(); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when all { test.value > 5; test.value < 10; } { do test(); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when all for 5m { test.value > 5; } { do test(); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when any { test.value > 5; test.value < 0; } { do test(); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when any for 10s { test.value > 5; } { do test(); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when for 1h { test.value > 5; test.value < 10; } { do test(); } }");
