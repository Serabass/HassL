...
public class ActionsTests
{
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when test.value == 5 { do test.func(1, \"test\", true); } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when test.value == 5 { wait test.value == 0 for 10s; } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when test.value == 5 { wait test.value == 0 for 10s timeout 5m; } }");
    ...
    {
        // Act
        var result = HassLanguageParser.Parse("automation \"Test\" { when test.value == 5 { do test.func1(); do test.func2(); wait test.value == 0 for 10s; } }");
